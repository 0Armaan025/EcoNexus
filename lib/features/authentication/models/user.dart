...
class UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(name: $name, uid: $uid, email: $email, profileImage: $profileImage, city: $city, password: $password, relaxationTime: $relaxationTime, eventsJoined: $eventsJoined)';
  }
